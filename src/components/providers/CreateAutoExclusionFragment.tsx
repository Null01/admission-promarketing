        ...
        <div className="flex flex-col p-2">
          <Card>
            ...
            <div className="flex items-center">
              <RadioButtonInput label={'Temporal hasta'} name={'temp'} onChange={() => {}}/>
              <RadioButtonInput label={'Indefinido'} name={'temp2'} onChange={() => {}}/>
            </div>
            <InputText onChange={() => {}}/>
          </Card>
        </div>
        <div className="flex justify-center items-center p-2">
          <Button className={'max-w-[359px]'} title={'enviar'} onClick={() => {}}/>
        </div>
      </div>
    </React.Fragment>
  );
